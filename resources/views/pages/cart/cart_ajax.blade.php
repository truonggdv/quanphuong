				...
				<table class="table table-condensed">
					...
					<tbody>
						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									...
									<input class="cart_quantity_input form-control" style="width: 80px;" type="number" min="1" name="qty[{{$cart['session_id']}}]" value="{{$cart['product_qty']}}"  >
						...
						<tr>
							...
							<td colspan="2">
							<li style="color: #5751b3; font-size: 20px;">Tổng tiền: <span style="color: red; font-weight: bold;">{{number_format($total,0,',','.')}} đ</span></li>
							@if(Session::get('coupon'))
							<li>
